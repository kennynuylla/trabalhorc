namespace Analise.Constantes
{
    public class RedeBaseConstantes
    {
        public string PastaTodasRedes { get => "Redes/"; }
        public string PastaPlots { get => "/codigo/png/"; }
        public string PastaScriptsComuns { get => "Comum/"; }
